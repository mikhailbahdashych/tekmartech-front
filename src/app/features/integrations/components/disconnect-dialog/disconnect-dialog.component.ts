...
@Component({
  ...
  template: `
    ...
    <mat-dialog-actions align="end">
      <button mat-button [disabled]="isDisconnecting()" (click)="onCancel()">Cancel</button>
      <button mat-flat-button class="disconnect-btn" [disabled]="isDisconnecting()" (click)="onDisconnect()">
        @if (isDisconnecting()) {
